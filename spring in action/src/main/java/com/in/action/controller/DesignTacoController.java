...
import com.in.action.model.Ingredient;
...
import com.in.action.model.Ingredient.Type;
...
public class DesignTacoController {
    @GetMapping public String showDesignForm(Model model) {
        ...
        model.addAttribute("design", new HomeController());
        return "design";
    }
    @PostMapping public String processDesign(){
